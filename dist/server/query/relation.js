import { Relation, ValtheraRemote } from "@wxn0brp/db";
...
async function createRelation(accessCfg, userId, res) {
    ...
    for (const key in accessCfg) {
        ...
        if (typeof remote === "string") {
            ...
            dbs[key] = global.dataCenter[remote].db;
...
router.post('/:type', async (req, res) => {
    ...
    try {
        ...
        const check = checkCollections(global.baseDir, req.body.accessCfg, params[1]);
